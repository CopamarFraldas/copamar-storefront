...
import { buscarIrmaosDaFamilia } from "./familia"
 ...
 * A descoberta da família mora em ./familia (fonte única, compartilhada com o
 * cross-sell do carrinho).
 */
