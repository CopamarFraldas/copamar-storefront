...
const components: Components = {
  h1: ({ children }) => (
    <h1 className="text-2xl font-semibold text-ui-fg-base mt-8 mb-4">
      {children}
    </h1>
  ),
  h2: ({ children }) => (
    <h2 className="text-xl font-semibold text-ui-fg-base mt-10 mb-3">
      {children}
    </h2>
  ),
  h3: ({ children }) => (
    <h3 className="text-lg font-semibold text-ui-fg-base mt-6 mb-2">
      {children}
    </h3>
  ),
  p: ({ children }) => (
