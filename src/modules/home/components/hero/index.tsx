...
const Hero = () => {
  return (
    <section className="relative bg-copamar-bg-light border-b border-ui-border-base">
      <div className="content-container py-12 small:py-16">
        <div className="grid grid-cols-1 small:grid-cols-2 gap-8 items-center">
          <div className="text-center small:text-left">
            <h1 className="text-3xl small:text-5xl font-bold text-copamar-primary leading-tight">
              Cuidado e dignidade
              <br />
              pra quem você ama
            </h1>
            <p className="text-lg text-copamar-text mt-4 max-w-xl mx-auto small:mx-0">
