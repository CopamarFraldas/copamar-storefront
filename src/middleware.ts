...
export async function middleware(request: NextRequest) {
  ...
  // (antes fazia redirect 307 pra MESMA URL → bots/validators/curl sem cookie entravam em loop infinito.
  //  servir a página direto + setar o cookie na resposta evita o loop e ainda economiza 1 redirect no browser)
  if (urlHasCountryCode && !cacheIdCookie) {
...
export const config = {
  matcher: [
    "/((?!api|entregas|manifest|_next/static|_next/image|favicon.ico|images|assets|png|svg|jpg|jpeg|gif|webp).*)",
  ],
}
